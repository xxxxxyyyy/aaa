---
title: Windows Error Code
layout: post
date: '2019-01-01'
categories: C++/C
permalink: "/archivers/2019-01-01/"
description: Fork 一份Windows错误代码
---
...
5771 远程启动数据库采用 NT 35 / NT 351 格式。NT 正在转换其为 NT 40 格式。完成转换后，JETCONV 转换器将写出应用事件日志。 
...
8528 正在添加的链接属性的语法不正确。正向链接只能有语法 2551、2557 和 25514，而反向链接只能有语法 2551
